package com.example.harrypottercaracters.activity
...
import com.example.harrypottercaracters.other.HarryPotterViewModel

//Thanks for taking the time to read my code
//I have used piccaso dependencies. A lot of the images dont have links so that why there is a lot of blanks but it load properly
// Any questions or feedback is always appreciated y
...
class MainActivity : AppCompatActivity() {
            ...
            if (it != null) {
                ...
                run {
                    for (i in 0 until it.size) {
                        ...
                        data.add(
                            RVViewModel(
                                sortedList[i].actor, sortedList[i].name,
                                sortedList[i].house,
                                sortedList[i].image
    ...
    private fun viewStudentUsersOffline() {
        val recyclerview = findViewById<RecyclerView>(R.id.recyclerview)
        recyclerview.layoutManager = LinearLayoutManager(this)
        val data = ArrayList<RVViewModel>()
    ...
    private fun viewAllGrifOffline() {
        val recyclerview = findViewById<RecyclerView>(R.id.recyclerview)
        recyclerview.layoutManager = LinearLayoutManager(this)
        val data = ArrayList<RVViewModel>()
    ...
    private fun viewRavUsersOffline() {
        val recyclerview = findViewById<RecyclerView>(R.id.recyclerview)
        recyclerview.layoutManager = LinearLayoutManager(this)
        val data = ArrayList<RVViewModel>()
    ...
    private fun viewHuffUsersOffline() {
        val recyclerview = findViewById<RecyclerView>(R.id.recyclerview)
        recyclerview.layoutManager = LinearLayoutManager(this)
        val data = ArrayList<RVViewModel>()
